...
public class LightningChannelerRecipieCatagory implements IRecipeCategory<LightningChannelerRecipe> {
    ...
    public final static ResourceLocation UID = new ResourceLocation(Tree.MOD_ID, "lightning");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(Tree.MOD_ID, "textures/gui/lightning_channeler_gui.png");
